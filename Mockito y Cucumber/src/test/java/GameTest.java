...
public class GameTest {
    ...
    //Indica que el objeto mockeable está en Game
    @InjectMocks
    private Game game;

    //Mock indica lo que voy a querer mockear
    @Mock
    Scanner scanner;
    ...
    @Before
    public void setup(){
        //capturamos lo que sale por consola
    ...
    public void when_writeQuit_then_exitGame(){
        //Importante: resources/mockito-extensions
